...
```mermaid
graph LR
  eta["<b>eta</b><br/>게이트웨이 · 인증<br/>nginx · Authentik · Headscale · gitea-mq"]
  psi["<b>psi</b><br/>GPU · CI/CD<br/>Nixbot · Nixbot DB · Docling · TEI"]
...
| 호스트 | 위치 | 주요 서비스 |
|--------|------|------------|
| **eta** | Vultr VPS | nginx 리버스 프록시, Authentik SSO, Headscale VPN, gitea-mq, Vaultwarden, Gatus, Upterm relay, ACME 인증서 |
| **psi** | KREN 베어메탈 | Nixbot+PostgreSQL+nginx/TLS, niks3 control plane, Docling (GPU), TEI, Apptainer, db-sync, 16TB NVMe + 60TB HDD |
